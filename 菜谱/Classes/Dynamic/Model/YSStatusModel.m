...
//    status.favorited = dicData[@"favorited"];
    ...
    status.user = [YSUserModel userModelWithDictionary:dicData[@"user"]];
    
    /** retweeted_status	object	被转发的原微博信息字段，当该微博为转发微博时返回 详细 */
    status.retweetedStatus = [YSStatusModel statusModelWithDictionary:dicData[@"retweeted_status"]];
